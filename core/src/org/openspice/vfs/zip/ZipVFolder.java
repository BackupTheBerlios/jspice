...
public class ZipVFolder extends PathAbsVFolder implements VFolder {
	...
	public static final ZipVFolder make( final ZipVVolume zvol, final String path ) {
		...
		if ( ze != null && ze.isDirectory() ) {
			...
			throw new Alert( ze == null ? "Entry does not exist" : "Entry is not a directory" ).culprit( "path", path ).culprit( "zip file", zvol.zip_file ).mishap();
		}
	}
	...
	private List listAll( final boolean vfiles, final boolean vfolders ) {
