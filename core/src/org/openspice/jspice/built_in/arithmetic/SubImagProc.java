...
import org.openspice.jspice.arithmetic.Complex;
import org.openspice.jspice.arithmetic.Mul;
import org.openspice.jspice.arithmetic.Sub;
import org.openspice.jspice.lib.CastLib;

public class SubImagProc extends Binary1InvokeProc {

	public Object invoke( final Object x, final Object y ) {
		return(
			Sub.doSub(
				CastLib.toNumber( x ),
				Mul.doMul( Complex.I, CastLib.toNumber( y ) )
			)
		);
	}
	
	public static final SubImagProc SUB_IMAG_PROC = new SubImagProc();
