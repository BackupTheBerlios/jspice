...
import org.openspice.jspice.built_in.elements.TagNameProc;
import org.openspice.jspice.built_in.elements.AttributeMapProc;
...
public class SpiceStandardNameSpace extends NameSpace {
	...
	private void install_built_ins() {
		...
		this.install( "attributeMap", AttributeMapProc.ATTRIBUTE_MAP_PROC );
		...
		this.install( "justLast", JustLastProc.JUST_LAST_PROC );
		...
		this.install( "last", LastProc.LAST_PROC );
		...
		this.install( "tagName", TagNameProc.TAG_NAME_PROC );
