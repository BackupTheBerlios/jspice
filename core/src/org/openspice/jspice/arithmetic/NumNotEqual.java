...
public class NumNotEqual extends BinaryArithmeticOperator {
	...
	public Object applyComplexes( final Complex x, final Complex y ) {
		return Boolean.valueOf( !NumEqual.equal( x, y ) );
	}

	public static final NumNotEqual NUM_NOT_EQUAL = new NumNotEqual();
