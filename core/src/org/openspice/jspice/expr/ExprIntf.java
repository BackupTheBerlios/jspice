...
public interface ExprIntf {
	...
	abstract Expr copy( ExprIterator kids );
	abstract Object visit( ExprVisitor visitor, Object arg );
	abstract Object visit( ExprVisitor visitor );
	abstract Expr bottomUp( ExprTransform t );
	abstract void showTree();
	abstract void showTree( final int nspaces );
}