...
public class LinesLoaderBuilder extends ValueLoaderBuilder {

//	public LinesLoaderBuilder( final JSpiceConf jconf ) {
//		super( jconf );
//	}

	static final class LinesLoader extends ValueLoader {

		private LinesLoader( final ValueLoaderBuilder vlb, final NameSpace ns ) {
			super( vlb, ns );
		}
	}
