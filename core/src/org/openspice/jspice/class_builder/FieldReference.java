...
public class FieldReference extends MiscReference {
...
//		this.methodName = class_and_method.substring( m + 1 );
	...
	public FieldReference( String className, String methodName, String descriptor ) {
		super( Constants.CONSTANT_Fieldref, className, methodName, descriptor );
...
//			answer.writeByte( Constants.CONSTANT_Fieldref );
