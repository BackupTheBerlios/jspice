...
public class MethodReference extends MiscReference {
...
//	int offset;
	...
	public MethodReference( String name ) {
		super( Constants.CONSTANT_Methodref, name );
...
//		this.methodName = class_and_method.substring( m + 1 );
	...
	public MethodReference( String className, String methodName, String descriptor ) {
		super( Constants.CONSTANT_Methodref, className, methodName, descriptor );
...
//			answer.writeByte( Constants.CONSTANT_Methodref );
